...
- build_steps: Array of 6-8 numbered steps.
  ...
  CRITICAL TOOL RULE: Every tool recommended in the build steps must be either completely free or have a meaningful free tier that allows the student to complete the task without paying. Never recommend paid-only tools, tools requiring a credit card for basic functionality, or enterprise software. Do not recommend LinkedIn Sales Navigator as a primary tool — use standard LinkedIn instead. If a paid tool is the best option, suggest the free alternative first and mention the paid version as an optional upgrade only.
